const mockProducts = [
  ...
  },
  {
    ...
    price: 599,
    description: "21.5 inches Full HD (1920 x 1080) widescreen IPS display. AMD Radeon free Sync technology. Response time: 4ms, refresh rate: 75Hz, pixel pitch: 0.2745mm.",
    category: "electronics",
  ...
  },
  {
    ...
    price: 29.95,
    description: "100% POLYURETHANE(shell) 100% POLYESTER(lining) 75% POLYESTER 25% COTTON (SWEATER), Faux leather material for style and comfort. 2 pockets of front, 2-For-One Hooded denim style faux leather jacket, Button detail on waist.",
    category: "women's clothing",
  ...
  },
  {
    ...
    price: 39.99,
    description: "Lightweight perfet for trip or casual wear. Long sleeve with hooded, adjustable drawstring waist design. Button and zipper front closure raincoat, fully stripes pattern.",
    category: "women's clothing",
